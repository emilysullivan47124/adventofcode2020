...
#Challenge two: using the same list of numbers, find 3 numbers that add up to 2020; what is the sum of those three number multiplied together
for x in numbers:
  for y in numbers:
    for z in numbers:
      if x+y+z == target:
